...
g++ -Wall -pedantic -pthread -DPOSIX_PRORITY_SETUP -DGATHER_ALL "${PROGRAM_CODE}" -o bin/latency_with_prio
...
sudo scripts/runscript.sh bin/latency_with_prio ${MICRO_TIME} output/out_with_prio output/data_with_prio 4
